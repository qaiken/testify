...
todo.App.prototype.render = function() {
	...
	// get selectors for each item on the page
	...
	// this bind ensures that when each item calls
	// the renderItem function, the 'this' within renderItem
	// will refer the todo.App and not the item itself
...
todo.App.prototype.renderItem = function(item) {
	...
	// once everything is rendered, we can append it to the DOM
...
// create a function that lets us grab an individual
// task based on the id number
